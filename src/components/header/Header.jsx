			...
			<div className='myMenuContainer'>
				{config.user===null
					?<>
						...
						<GenericIconButton className='kakao' src={kakaoIcon} onClick={loginRequest}>
							카카오로 로그인
						</GenericIconButton>
					</>
					:<>
						...
						<div className='serviceNav'>
							<Link to={'/my/info'} onClick={handleVisible.hide}>
								<div className='serviceNavItem'>
									<img className='icon' src={user2Icon} alt='회원 정보'/>
							...
							<Link to={'/my/favorites'} onClick={handleVisible.hide}>
								<div className='serviceNavItem'>
									<img className='icon' src={heartFillIcon} alt='찜한 목록'/>
							...
							<Link to={'/my/qna'} onClick={handleVisible.hide}>
								<div className='serviceNavItem'>
									<img className='icon' src={question2Icon} alt='1:1 문의'/>
				...
				<div className='serviceNav'>
					<Link to={'/intro/main'} onClick={handleVisible.hide}>
						<div className='serviceNavItem'>
							<img className='icon' src={balloonIcon} alt='경복궁별빛야행'/>
					...
					<Link to={'/course/min40'} onClick={handleVisible.hide}>
						<div className='serviceNavItem'>
							<img className='icon' src={shoesIcon} alt='경복궁나들이'/>
					...
					<Link to={'/notice/main'} onClick={handleVisible.hide}>
						<div className='serviceNavItem'>
							<img className='icon' src={noticeIcon} alt='알려드립니다'/>
					...
					<Link to={'/festival/gallery'} onClick={handleVisible.hide}>
						<div className='serviceNavItem'>
							<img className='icon' src={locationIcon} alt='축제둘러보기'/>
